...
more difficult. For Firefox, the [[http://www.wired-marker.org/][Wired Marker]] addon works well.  For Chromium-based browsers, see [[https://www.lifehacker.com.au/2020/06/how-to-create-a-bookmark-that-jumps-to-specific-text-on-a-website/][here]]. (It might also work with newer versions of Firefox.)
